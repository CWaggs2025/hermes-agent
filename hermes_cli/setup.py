...
def _print_setup_summary(config: dict, hermes_home):
    ...
    if subscription_features.web.managed_by_nous:
        ...
        tool_status.append(("Web Search & Extract", False, "EXA_API_KEY, PARALLEL_API_KEY, FIRECRAWL_API_KEY/FIRECRAWL_API_URL, TAVILY_API_KEY, PERPLEXITY_API_KEY, KEENABLE_API_KEY, or SEARXNG_URL"))
